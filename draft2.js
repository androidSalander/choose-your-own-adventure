...
hitAndRunBackButton.addEventListener("click", goBack8)

let lunch = document.querySelector("#lunch")

let playerChoose4 = function() {
  choiceLunchWhere.classList.toggle("hidden")
  lunch.classList.toggle("hidden")
}

let pickledHerring = document.querySelector("#pickled-herring")

pickledHerring.addEventListener("click", playerChoose4)

let goBack9 = function() {
  lunch.classList.toggle("hidden")
  choiceLunchWhere.classList.toggle("hidden")
}
...
lunchBackButton.addEventListener("click", goBack9)
